function[LINK, SOURCE_LINK, SINK_LINK, JUNCTION, T, deltaTinSecond, ROUND_SAMPLES]...
    = updateFunAndSimulate_newStrategy_type2_network(POPULATION_2, LINK, SOURCE_LINK, SINK_LINK, JUNCTION,...
    CONFIG, PARAMETER, sensorMetaDataMap, configID, stage,...
    linkMap, ROUND_SAMPLES,  occuDataMatrix_source, occuDataMatrix_sink, travelTime_means, travelTime_vars)
