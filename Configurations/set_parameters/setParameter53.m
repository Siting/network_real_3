function[PARAMETER]=setParameter53(PARAMETER)

% This file contains parameter settings for ABC algorithm

PARAMETER.parameterID=53;
...
PARAMETER.thresholdVector = [0.5 0.5; 0.3498 0.3498; 0.3252 0.3252; 0.3182 0.3182; 0.3109 0.3109;...
    0.3040 0.3040; 0.3008 0.3008;];
