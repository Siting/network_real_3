function[CONFIG]=setConfig53(CONFIG)
...
% parameters
CONFIG.parameterID = 53;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-53';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-53';
