function[CONFIG]=setConfig51(CONFIG)
...
% parameters
CONFIG.parameterID = 51;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-51';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-51';
