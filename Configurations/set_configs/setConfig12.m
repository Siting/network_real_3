function[CONFIG]=setConfig12(CONFIG)
...
% parameters
CONFIG.parameterID = 12;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-12';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-12';
