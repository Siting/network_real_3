function[CONFIG]=setConfig52(CONFIG)
...
% parameters
CONFIG.parameterID = 52;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-52';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-52';
